...
from locomotion.gait_generator import gait_generator
...
class OffsetGaitGenerator(gait_generator.GaitGenerator):
    ...
    def leg_states(self):
        ...
        for leg_id in range(self.robot.num_legs):
            ...
            if (_leg_states[leg_id] == gait_generator.LegState.STANCE
                ...
                _leg_states[leg_id] = gait_generator.LegState.LOSE_CONTACT

            # Detect early touch down status
            if (_leg_states[leg_id] == gait_generator.LegState.SWING
                ...
                _leg_states[leg_id] = gait_generator.LegState.EARLY_CONTACT
