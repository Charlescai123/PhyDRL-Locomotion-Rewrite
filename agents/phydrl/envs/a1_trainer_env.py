...
class A1TrainerEnv:
    ...
    def step(self, action, action_mode='mpc'):
        ...
        if action_mode == 'residual':
            ...
            # print(f"mode: {self.mpc_controller.mode}")
            # print(f"swing desired speed: {self.mpc_controller.swing_leg_controller.desired_speed}")
            # print(f"stance desired speed: {self.mpc_controller.stance_leg_controller.desired_speed}")
